threshold = .05;
color_thresh = [.05 .1];
sel_voxels_row = 81:83;
sel_voxels_col = 144:146;
...
avg_voxels_ctrl(3,1) = mean(matched_relative_1(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(3,2) = mean(matched_relative_2(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(3,3) = mean(matched_relative_3(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(3,4) = mean(matched_relative_4(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(3,5) = mean(matched_relative_5(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(3,6) = mean(matched_relative_6(sel_voxels_row,sel_voxels_col),"all");
