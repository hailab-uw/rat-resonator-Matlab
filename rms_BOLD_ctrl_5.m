threshold = .05;
color_thresh = [.05 .1];
sel_voxels_row = 62:66;
sel_voxels_col = 145:151;
...
avg_voxels_ctrl(5,1) = mean(matched_relative_1(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(5,2) = mean(matched_relative_2(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(5,3) = mean(matched_relative_3(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(5,4) = mean(matched_relative_4(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(5,5) = mean(matched_relative_5(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(5,6) = mean(matched_relative_6(sel_voxels_row,sel_voxels_col),"all");
