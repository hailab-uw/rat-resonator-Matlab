...
avg_voxels_exp(3,1) = mean(matched_relative_1(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(3,2) = mean(matched_relative_2(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(3,3) = mean(matched_relative_3(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(3,4) = mean(matched_relative_4(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(3,5) = mean(matched_relative_5(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(3,6) = mean(matched_relative_6(sel_voxels_row,sel_voxels_col),"all");
