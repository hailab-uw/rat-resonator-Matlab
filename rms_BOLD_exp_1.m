threshold = .05;
color_thresh = [.05 .15];
sel_voxels_row = 66:68;
sel_voxels_col = 139:142;
...
avg_voxels_exp(1,1) = mean(matched_relative_1(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(1,2) = mean(matched_relative_2(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(1,3) = mean(matched_relative_3(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(1,4) = mean(matched_relative_4(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(1,5) = mean(matched_relative_5(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(1,6) = mean(matched_relative_6(sel_voxels_row,sel_voxels_col),"all");
