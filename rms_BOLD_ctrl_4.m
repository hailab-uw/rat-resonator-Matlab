threshold = .08;
color_thresh = [.05 .15];
sel_voxels_row = 87:90;
sel_voxels_col = 147:152;
...
avg_voxels_ctrl(4,1) = mean(matched_relative_1(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(4,2) = mean(matched_relative_2(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(4,3) = mean(matched_relative_3(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(4,4) = mean(matched_relative_4(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(4,5) = mean(matched_relative_5(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_ctrl(4,6) = mean(matched_relative_6(sel_voxels_row,sel_voxels_col),"all");
