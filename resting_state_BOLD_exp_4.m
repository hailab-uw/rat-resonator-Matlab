...
[matched_smoothed_1,alpha_1] = mask_threshold(brain_masked,...
    time_smoothed_relative_t(:,:,84),threshold,color_thresh);
[matched_smoothed_2,alpha_2] = mask_threshold(brain_masked,...
    time_smoothed_relative_t(:,:,95),threshold,color_thresh);
[matched_smoothed_3,alpha_3] = mask_threshold(brain_masked,...
    time_smoothed_relative_t(:,:,107),threshold,color_thresh);
[matched_smoothed_4,alpha_4] = mask_threshold(brain_masked,...
    time_smoothed_relative_t(:,:,112),threshold,color_thresh);
...
function [matched_relative,alpha_map] = mask_threshold(maskedImage,...
    ...
    alpha_map = mat2gray(matched_relative,color_thresh);
end 