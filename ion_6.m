...
t2_slice_pre = get_t2('C:\Users\suyas\Documents\GitHub\rat-resonator-Matlab\Suyash_rat_surgery_04_18_injection\3770_T2\1\3770_',14);
...
rs_BOLD_t(:,:,1:500) = load_BOLD('C:\Users\suyas\Documents\GitHub\rat-resonator-Matlab\Suyash_rat_surgery_04_18_injection\3776_RS_bold\1\3776_',1:500);
...
ion_t(:,6) = squeeze(mean(ion_t_full(67:69,148:150,:),[1 2]));
for i=1:6
    avg_ion(6,i) = mean(ion_t((i-1)*500+1:i*500,6));
end