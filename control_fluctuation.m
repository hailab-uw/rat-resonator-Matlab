...
smoothed_control_1 = imgaussfilt(rep_control_1,1);
smoothed_control_2 = imgaussfilt(rep_control_2,1);
smoothed_control_3 = imgaussfilt(rep_control_3,1);
smoothed_control_4 = imgaussfilt(rep_control_4,1);
smoothed_control_5 = imgaussfilt(rep_control_5,1);
smoothed_control_6 = imgaussfilt(rep_control_6,1);

[matched_relative_1,alpha_1] = mask_BOLD(rms_masked,rep_control_1,threshold);
[matched_relative_2,alpha_2] = mask_BOLD(rms_masked,rep_control_2,threshold);
[matched_relative_3,alpha_3] = mask_BOLD(rms_masked,rep_control_3,threshold);
[matched_relative_4,alpha_4] = mask_BOLD(rms_masked,rep_control_4,threshold);
[matched_relative_5,alpha_5] = mask_BOLD(rms_masked,rep_control_5,threshold);
[matched_relative_6,alpha_6] = mask_BOLD(rms_masked,rep_control_6,threshold);
...
function [matched_relative,alpha_BOLD] = mask_BOLD(maskedImage,relative,threshold)
    ...
    alpha_BOLD = mat2gray(matched_relative,[0 .1]);
end