...
avg_voxels_exp(7,1) = mean(matched_relative_1(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(7,2) = mean(matched_relative_2(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(7,3) = mean(matched_relative_3(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(7,4) = mean(matched_relative_4(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(7,5) = mean(matched_relative_5(sel_voxels_row,sel_voxels_col),"all");
avg_voxels_exp(7,6) = mean(matched_relative_6(sel_voxels_row,sel_voxels_col),"all");
